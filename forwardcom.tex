...
%
% Программируемые специфичные для приложения команды
\subfile{fwc-programmable-instructions.tex}
%
% Микроархитектура и дизайн конвейера
\subfile{fwc-microarchitecture-and-pipeline.tex}
%
% Модель памяти
% - Защита памяти потока
% - Управление памятью
\subfile{fwc-memory-model.tex}
%
% Системное программирование
% - Карта памяти
% - Стек вызовов
% - Системные вызовы и системные функции
% - Межпроцессные вызовы
% - Обработка сообщений об ошибках
\subfile{fwc-system-programming.tex}
%
% Стандартизация ABI и программной экосистемы
% - Поддержка компилятором
% - Представление двоичных данных
% - Дальнейшие соглашения для объектно--ориентированных языков
% - Соглашения о вызовах функций
% - Соглашения об использовании регистров
% - Искажение имён для перегрузки функций
\subfile{fwc-abi-standard.tex}
%
% - Двоичный формат для объектных файлов и исполняемых файлов
% - Библиотеки функций и методы компоновки
% - Система диспетчеризации библиотечных функций
% - Предсказание размера стека
% - Обработка исключений, раскрутка стека, и отладочная информация
\subfile{fwc-object-file-format.tex}
%
% - Синтаксис языка ассемблера
\subfile{fwc-assembly-language-syntax.tex}
%
% Заключение
\subfile{fwc-conclusion.tex}
%
%% Revision history
%\subfile{fwc-revision-history.tex}
%
%% Copyright notice
%\subfile{fwc-copyright-notice.tex}
\end{document}
